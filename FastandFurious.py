...
def main():
    ...
    if num == 0:
        ...
        print(
            "King Mongkut's Institute of Technology Ladkrabang (KMITL for short) is a research and educational institution in Thailand."
        )
    elif num == 2:
        print(
        ...
        print(
            "He coined the term \"black body\" radiation in 1862, and two different sets of concepts (one in circuit theory, and one in spectroscopy) are named \"Kirchhoff's laws\"."
        )
    elif num == 7:
        print(
